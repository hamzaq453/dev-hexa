...
const LandingHeroMinimalDark = () => {
  ...
  return (
    <section className="relative min-h-screen bg-black text-white md:flex items-center pt-32 md:pt-0 overflow-hidden select-none">
      {/* Grid overlay */}
      <div
      ...
      <div
        className="absolute bottom-1/4 left-1/3 w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 bg-[#03388F] rounded-full filter blur-[80px] opacity-5 animate-pulse"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="mb-4 text-center sm:text-left md:pl-10 lg:pl-16 xl:pl-0">
              ...
              <div className="mr-4 mb-7 sm:mb-0 sm:mr-8 md:mr-10 inline-block">
                <span className="text-3xl sm:text-xl md:text-2xl lg:text-3xl text-white/70 font-light text-right">
                  You've Got a <br className="hidden sm:block" /> Great Idea
                </span>
              </div>
              <span className="text-6xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-9xl font-bold -tracking-normal leading-tight md:leading-[1.1]">
                We'll turn it
                <br />
                into a great
                <br />
                <span className="inline-block">
                  <span className="text-[#035D9D]" ref={typedRef}>
                    Website
                  </span>
                </span>
              </span>
            ...
            <motion.div
              ...
              className="absolute -bottom-20 right-42 sm:bottom-12 sm:right-8 md:-bottom-16 md:right-24 lg:right-32 lg:bottom-12 z-10"
            >
              <Link
                href="/contact"
