  ...
  return (
    <section className="relative w-full py-24 bg-background text-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/6 right-1/6 w-[500px] h-[500px] bg-gradient-conic from-primary/15 via-primary-dark/10 to-primary-darker/6 rounded-full blur-3xl opacity-50" />
        <div className="absolute bottom-1/6 left-1/6 w-[420px] h-[420px] bg-gradient-conic from-primary-dark/12 via-primary/8 to-primary-darker/10 rounded-full blur-3xl opacity-40" />
        <div className="absolute top-1/3 left-1/4 w-[280px] h-[280px] bg-gradient-radial from-primary/8 via-primary-dark/5 to-transparent rounded-full blur-2xl opacity-30" />
        <div className="absolute bottom-1/3 right-1/4 w-[320px] h-[320px] bg-gradient-radial from-primary-dark/6 via-primary/4 to-transparent rounded-full blur-2xl opacity-30" />
